import Produit1 from "../assets/fitness-1882721_1920.jpg";
import Produit2 from "../assets/supp.jpg";
import Produit3 from "../assets/etirement.jpg";
import Produit4 from "../assets/food.jpeg";
import Produit5 from "../assets/groupe.jpg";
import Produit6 from "../assets/plan.jpg";
...
export const ProduitList = [
  {
    ...
    name: "Équipements",
    image: Produit1,
    desc: "Guide sur les équipements à utiliser pour commencer",
    price: 15.99,
  },
  {
    id: 2,
    name: "Suppléments",
    image: Produit2,
    desc: "Guide sur les suppléments alimentaires tel que la proteine, les BCAA, la créatine, etc.",
    price: 39.99,
  },
  {
    id: 3,
    name: "Étirements",
    image: Produit3,
    desc: "Guide sur les avantages de l'étirement pour la progression musculaire",
    price: 10.99,
  },
  {
    id: 4,
    name: "Alimentation",
    image: Produit4,
    desc: "Guide sur l'alimentation saine",
    price: 17.99,
  },
  {
    id: 5,
    name: "Sèche",
    image: Produit5,
    desc: "Guide sur une perte de poids bien réussi",
    price: 19.99,
  },
];
